...
class Solution{
    public Tree cloneTree(Tree tree){
       ...
       Tree node = separateTree(tree);
       
       return node;
     }
     
     public Tree separateTree(Tree node){
         if(node == null){
             return null;
         }
         
         Tree leftNode = separateTree(node.left.left);
         Tree rightNode = separateTree(node.right);
     ...
     public void duplicateTree(Tree node){
         if(node == null){
             return;
         }
